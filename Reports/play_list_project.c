...
void addSong(char song[], char songGenre[], int personIndex) {
    printf("노래를 입력하세요: ");
...
int main() {
    ...
    while (1) {
        ...
        case 1:
            ...
            addSong(peopleFavoriteSongs[personIndex - 1][songCount[personIndex - 1] % MAX_SONGS], inputGenre, personIndex - 1);
            break;
